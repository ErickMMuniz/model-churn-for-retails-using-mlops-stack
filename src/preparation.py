...
def process() -> None:
    ...
    print(f"Raw data has {df_raw.shape[0]} rows, prepared data has {df.shape[0]} rows. Difference: {df_raw.shape[0] - df.shape[0]}")
